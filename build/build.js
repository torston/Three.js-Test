...
var Renderer = (function () {
    ...
    Renderer.prototype.call = function () {
        var _this = this;
        ...
        document.getElementById("canvas").addEventListener('click', function (event) { return _this.mouseClick(event); }, true);
    ...
    Renderer.prototype.mouseClick = function (event) {
        ...
        for (var i = 0; i < intersects.length; i++) {
            var element = intersects[i].object;
    ...
    Renderer.prototype.connect = function () {
        console.log("Connect!");
    ...
    Renderer.prototype.build = function (height) {
        var rectLength = 20, rectWidth = 20;
        var g = new Array();
        var v = [];
        var index = 0;
        this.meshes.forEach(function (element) {
...
var Controls = (function () {
    ...
    Controls.prototype.initSceneMoveControls = function () {
    ...
    Controls.prototype.initGlobalControls = function () {
        this.sceneSettings = new SceneSettings();
        var s = this.sceneSettings;
        var gui = new dat.GUI();
        var sunRotateController = gui.add(s, 'sunRotation');
        var editModeController = gui.add(s, 'editingMode');
        sunRotateController.onFinishChange(function (value) {
            controls.setSunRotate(value);
        });
        editModeController.onFinishChange(function (value) {
        ...
        var setPositionButton = { set: function () { controls.setPosition(); } };
        folder.add(setPositionButton, 'set');
    };
    Controls.prototype.setEditModeEnabled = function (value) {
        console.log("setEditModeEnabled: " + value);
    };
    Controls.prototype.setSunRotate = function (value) {
